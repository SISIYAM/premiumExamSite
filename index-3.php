    ...
    <section class="pt-0 pt-lg-5">
      <div class="container">
        ...
        <div class="row g-4">
          <!-- Card START -->
          <?php
            $select = mysqli_query($con, "SELECT * FROM package WHERE status = 0");
    ...
    <div class="container">
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-3">
          ...
          <p class="my-3 text-muted">Eduport education theme, built specifically for the education centers which is
      ...
      <div class="py-3">
        <div class="container px-0">
          <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
            <!-- copyright text -->
            <div class="text-muted text-primary-hover"> Copyrights <a href="#" class="text-reset">©2021 Eduport</a>. All
              rights reserved. </div>
            <!-- copyright links-->
            <div class=" mt-3 mt-md-0">
              <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item text-primary-hover"><a class="nav-link pe-0" href="#">Privacy policy</a>
                </li>
              </ul>
            </div>
          </div>
